...
class MainWorld:
    def __init__(self, game, BASE_DIR: Path) -> None:
        """definice hlavniho sveta co se tam bude nachazet jakoze objekty"""
    ...
    def update(self, dt: float, screen: pygame.Surface) -> None:
        """
            kontrola kolize s oblekty a reseni logiky

            kontrola pouzivani itemu a jejich

            kontrola swapovani veci v inventari
