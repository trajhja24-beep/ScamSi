...
from scamSi.src.settings import *
from scamSi.src.entities.player import Player
from scamSi.src.global_set.ui import ProgressBar
from scamSi.src.global_set.ui import Inventory
from scamSi.src.worlds.main_world import MainWorld
